      ...
      <main className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 p-6 rounded-lg border border-slate-800 shadow-xl">
          ...
          <div className="flex items-end gap-2">
            <span className="text-5xl font-black text-white">{telemetry.battery}%</span>
        ...
        <div className="bg-slate-900 p-6 rounded-lg border border-slate-800 shadow-xl">
          ...
          <div className="flex flex-col">
            <span className={`text-5xl font-black transition-colors ${telemetry.temp > 30 ? 'text-orange-500' : 'text-white'}`}>
              {telemetry.temp}°C
            </span>
        ...
        <div className="bg-slate-900 p-6 rounded-lg border border-slate-800 shadow-xl">
          ...
          <div className="flex flex-col">
            <span className="text-5xl font-black text-white">{telemetry.signal} dBm</span>
