    ...
    return (
        ...
        >
            ...
            <div className="fadeIn flex space-x-6 mt-2">
                ...
                {/* Email */}
                <a href="mailto:Arduino731@gmail.com" className="colorTextOpposite opacity-80 hover:opacity-100 hover:scale-110 transition-all duration-200" aria-label="Email">
