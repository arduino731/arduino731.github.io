    ...
    return (
        ...
        >
            ...
            <div className="fadeIn flex space-x-6 mt-2">
                {/* GitHub */}
                <a href="https://github.com/arduino731" target="_blank" rel="noopener noreferrer" className="colorTextOpposite opacity-80 hover:opacity-100 hover:scale-110 transition-all duration-200" aria-label="GitHub">
