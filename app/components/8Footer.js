        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-5">
              {/* GitHub */}
              <a href="https://github.com/bvanvlymen" target="_blank" rel="noopener noreferrer" className="colorText hover:scale-110 transition-transform duration-200" aria-label="GitHub">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/bvanvlymen-dev" target="_blank" rel="noopener noreferrer" className="colorText hover:scale-110 transition-transform duration-200" aria-label="LinkedIn">
